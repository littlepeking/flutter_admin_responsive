...
import 'package:enhantec_platform_ui/framework/widgets/eh_tabs_view/scrollable_positioned_list/lib/item_positions_listener.dart';
import 'package:enhantec_platform_ui/framework/widgets/eh_tabs_view/scrollable_positioned_list/lib/scrollable_positioned_list.dart';
                    ...
                    () => ScrollablePositionedList.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Obx(() {
                          ...
                          if (controller.tabsConfig.length < index + 1 ||
                              controller.tabsConfig[index].isDeleted)
